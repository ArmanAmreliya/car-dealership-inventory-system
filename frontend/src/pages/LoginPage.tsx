...
export function LoginPage() {
  ...
  return (
    <>
      {/* Beautiful car-gif loading overlay after login */}
      <AnimatePresence>
        {showLoader && (
          <LoginLoadingScreen onComplete={handleLoaderComplete} duration={2400} />
        )}
      </AnimatePresence>
          ...
          <div className="my-auto relative z-10 max-w-md space-y-6">
            <div className="relative flex justify-center">
              <img
                ...
                style={{ mixBlendMode: 'screen', filter: 'drop-shadow(0 8px 32px rgba(20,184,166,0.35)) brightness(1.08)' }}
              />
            </div>
